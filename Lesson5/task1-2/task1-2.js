/* ______________________Task 1-2______________________ */
...
function drawChess() {
    ...
    let figure = {
        ...
        7: ['-263px -116px', '-484px -116px', '-372px -116px', '-150px -116px', '-38px -116px', '-372px -116px', '-484px -116px', '-263px -116px'],
    };
    ...
    for (let i = 0; i < 8; i++) {
        for (let j = 0; j < 8; j++) {
            ...
            if (figure[i] !== undefined && figure[i][j] !== undefined) {
                block.style.backgroundImage = 'url(chess-symbols-set.png)';
